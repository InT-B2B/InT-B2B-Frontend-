...
export function MenuUI({
    ...
    return (
        <nav
            className={`menu lg:hidden bg-white-610 min-h-[100dvh] absolute top-0 left-0 right-0 ${toggle ? 'left-0' : 'left-[-300dvw] hidden'
                }`}
        >
            ...
            <ul className="p-6 flex gap-6 flex-col place-items-start bg-white-100">
                <li className=" flex flex-col lg:hidden gap-5 ">
                    <div className="group h flex flex-col ali justify-center gap-1">
                        ...
                        {router.pathname === '/explore' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                    </div>
                    <div className=" group flex flex-col ali justify-center  gap-1 ">
                        <Link className={activeLink('/marketplace')} href={'/marketplace'}>
                            Marketplace
                        </Link>
                        {router.pathname === '/marketplace' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                    </div>
                </li>
                ...
                {auth && (
                    <div className="mt-4 flex flex-col items-baseline gap-6 w-[100%]">
                        <div className=" group flex flex-col  justify-center  gap-1 ">
                            ...
                            {router.pathname === '/profile' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                        </div>
                        <div className=" group flex flex-col ali justify-center  gap-1 ">
                            <Link className={activeLink('/shop')} href={'/shop'}>
                                Your Shop
                            </Link>
                            {router.pathname === '/shop' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                        </div>
                        <div className=" group flex flex-col ali justify-center  gap-1 ">
                            <Link className={activeLink('/dashboard')} href={'/dashboard'}>
                                Customer Dashboard
                            </Link>
                            {router.pathname === '/dashboard' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                        </div>
                        <div className=" group flex flex-col ali justify-center  gap-1 ">
                            ...
                            {router.pathname === '/user/customer-purchase-dashboard' ? (
                                <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" />
                            ) : null}
                        </div>
                        <div className=" group flex flex-col ali justify-center  gap-1 ">
                            <Link
                            ...
                            {router.pathname === '/portfolio' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                        </div>
                        <div className=" group flex flex-col ali justify-center  gap-1 ">
                        ...
                        <div className=" group flex flex-col ali justify-center  gap-1 ">
                            ...
                            {router.pathname === '/settings' ? <div className="w-[100%] h-0.5 bg-[#64D1FF] rounded-lg" /> : null}
                        </div>
