...
function Footer() {
    return (
        <footer className="mt-auto font-manropeL bg-[#64D1FF] text-md text-white-100 leading-[1.5]">
            <section className="px-6 py-[4rem] flex flex-col gap-12 md:py-[4rem] md:flex-row md:justify-between xl:max-w-[77.5rem] xl:mx-auto">
                ...
                <div className="grid grid-cols-2 gap-[4rem] justify-between md:gap-[4rem] lg:grid-cols-3 xl:gap-16">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <ul className="flex flex-col gap-2 font-normal">
                            <li>
                                <div href="/marketplace" className="hover:underline">
                                    Marketplace
                                </div>
                            </li>
                            <li>
                                <div href="/shop" className="hover:underline">
                                    Shop
                                </div>
                            </li>
                        </ul>
