...
function ProductCard({
    ...
    const stars = {
        1: { src: "../../../public/assets/images/stars/1StarRating.png", alt: '1 Star' },
        2: { src: "../../../public/assets/images/stars/2StarRating.png", alt: '2 Stars' },
        3: { src: "../../../public/assets/images/stars/3StarRating.png", alt: '3 Stars' },
        4: { src: "../../../public/assets/images/stars/4StarRating.png", alt: '4 Stars' },
                    ...
                    <div>
                        {starRating ? (
                            <div className="flex flex-row items-center gap-[5px]">
                                <Image src={stars[5].src} alt="" width={111} height={20} className="" />
